...
const QUOTES = [
  ...
  { text: "I really appreciated the insights and experience Dr. Karam shared. The course really opened my eyes to a future career path in civil engineering and I'm seriously considering it now. It was an amazing opportunity.", footer: 'A 2026 Pathway Scholar' },
  { text: "It was an amazing program. I learned so much from the course, especially during the bridge design project. Working on our bridge, the Sunshine Project, was definitely the highlight of the week. Before this program, I was interested in civil engineering, but this course really confirmed that it's what I want to pursue in the future. Seeing how engineering concepts come together in real projects made me even more excited about the field.", footer: 'A 2026 Pathway Scholar' },
